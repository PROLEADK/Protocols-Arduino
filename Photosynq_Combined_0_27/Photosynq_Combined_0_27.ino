...
- added a 'protocol_repeat' which repeats the same protocol
...
// NOTE: for act, act2, alt1, and alt2, you can choose a measuring light.  If you do there are no preset states.  Select 2 for off, or 1 for on.
      ...
      if (baseline_apply == 1) {                                                                  // print baseline calibrations values if requested.
        ...
        for (i=0;i<sizeof(all_pins)/sizeof(float);i++) {
          Serial.print(i);
        ...
        for (i=0;i<sizeof(calibration_baseline_slope_850)/sizeof(float);i++) {
          Serial.print(i);
        ...
        for (i=0;i<sizeof(calibration_baseline_slope_605)/sizeof(float);i++) {
          Serial.print(i);
      ...
      for (i=0;i<sizeof(calibration_spad_blank)/sizeof(float);i++) {
        Serial.print(i);
...
#endif                                                                               
      for (z=0;z<total_pulses;z++) {                                            // cycle through all of the pulses from all cycles
