...
*/
        ...
        print_get_userdef0(get_userdef0,get_userdef1,get_userdef2,get_userdef3,get_userdef4,get_userdef5,get_userdef6,get_userdef7,get_userdef8,get_userdef9,get_userdef10); // check to see if we need to print any of the user defined calibrations
...
void call_print_calibration (int _print) {
  ...
  EEPROM_readAnything(1430,userdef10);
  EEPROM_readAnything(1438,pwr_off_ms);
  if (pwr_off_ms[0] > 0 | pwr_off_ms[0] < 5000) {                                                // in case pwr_off_ms is less than 5 seconds, set it to 2 minutes by default, otherwise leave it as whatever the user defined in EEPROM
    pwr_off_ms[0] = 120000;
  }
  else if (pwr_off_ms[0] < 0) {                                                               // in case pwr_off_ms is < 0 , then make it maximum time (functionally never turn off)
    pwr_off_ms[0] = 99999999999;
  }
  ...
  if (_print == 1) {                                                                                      // if this should be printed to COM port --
    ...
    print_cal_userdef("userdef6", userdef6 ,0);
    print_cal_userdef("userdef7", userdef7 ,0);
    print_cal_userdef("userdef8", userdef8 ,0);
    print_cal_userdef("userdef9", userdef9 ,0);
    print_cal_userdef("userdef10", userdef10 ,0);
    print_cal_userdef("pwr_off_ms", pwr_off_ms,1);
  }
}
...
void print_get_userdef0(int _0,int _1,int _2,int _3,int _4,int _5,int _6,int _7,int _8,int _9,int _10) {
    if (_0 == 1) {
      Serial.print("\"get_userdef0\":[");
      Serial.print(userdef0[0]);
      Serial.print(",");
    ...
    if (_1 == 1) {
      ...
      Serial1.print(userdef1[0]);
      Serial1.print(",");
      Serial1.print(userdef1[1]);
      Serial1.print("],");
    }      
    if (_2 == 1) {
      Serial.print("\"get_userdef2\":[");
      ...
      Serial1.print(userdef2[0]);
      Serial1.print(",");
      Serial1.print(userdef2[1]);
      Serial1.print("],");
    }      
    if (_3 == 1) {
      Serial.print("\"get_userdef3\":[");
      ...
      Serial1.print(userdef3[0]);
      Serial1.print(",");
      Serial1.print(userdef3[1]);
      Serial1.print("],");
    }      
    if (_4 == 1) {
      Serial.print("\"get_userdef4\":[");
      ...
      Serial1.print(userdef4[0]);
      Serial1.print(",");
      Serial1.print(userdef4[1]);
      Serial1.print("],");
    }      
    if (_5 == 1) {
      Serial.print("\"get_userdef5\":[");
      ...
      Serial1.print(userdef5[0]);
      Serial1.print(",");
      Serial1.print(userdef5[1]);
      Serial1.print("],");
    }      
    if (_6 == 1) {
      Serial.print("\"get_userdef6\":[");
      ...
      Serial1.print(userdef6[0]);
      Serial1.print(",");
      Serial1.print(userdef6[1]);
      Serial1.print("],");
    }      
    if (_7 == 1) {
      Serial.print("\"get_userdef7\":[");
      ...
      Serial1.print(userdef7[0]);
      Serial1.print(",");
      Serial1.print(userdef7[1]);
      Serial1.print("],");
    }      
    if (_8 == 1) {
      Serial.print("\"get_userdef8\":[");
      ...
      Serial1.print(userdef8[0]);
      Serial1.print(",");
      Serial1.print(userdef8[1]);
      Serial1.print("],");
    }      
    if (_9 == 1) {
      Serial.print("\"get_userdef9\":[");
      ...
      Serial1.print(userdef9[0]);
      Serial1.print(",");
      Serial1.print(userdef9[1]);
      Serial1.print("],");
    }      
    if (_10 == 1) {
      Serial.print("\"get_userdef10\":[");
      ...
      Serial1.print(userdef10[0]);
      Serial1.print(",");
      Serial1.print(userdef10[1]);
      Serial1.print("],");
    }      
}

void add_userdef(int location, int num_of_objects, int bytes) {
