...
unsigned long pulselengthon = 25; // pulse length in us... minimum = 6us
float cyclelength = .01; // in seconds... minimum = pulselengthon + 7.5us
unsigned long starttimer0, starttimer1, starttimer2;
float runlength = 1.5; // in seconds... minimum = cyclelength
char filename[13] = "ALGAE"; // Base filename used for data files and directories on the SD Card
const char* basicfluorending = "-F.CSV"; // filename ending for the basicfluor subroutine - just make sure it's no more than 6 digits total including the .CSV
int saturatingcycleon = 30; //The cycle number in which the saturating light turns on (set = 0 for no saturating light)
int saturatingcycleoff = 100; //The cycle number in which the saturating light turns off
