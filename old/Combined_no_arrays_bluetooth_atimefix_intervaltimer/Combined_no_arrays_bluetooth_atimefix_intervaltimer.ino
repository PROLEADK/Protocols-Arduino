...
//        Serial.println("Now running Basic Fluorescence");
//        basicfluor();
          dirkf();
        dcalculations();
...
//    PITimer2.period(dcyclelength);
    ...
    if (x<dnoactruns) {
      ...
      Serial.print("Total run time is ~: ");
      Serial.println(end1-starttimer0-100-30); // 30 is estimate of the additional time requires for something (I can't remember!)
    }
...
void dcalculations() {
  ...
  Serial.print("expected run length(measuring pulses):  ");
  Serial.println(drunlength/(dcyclelength*1000000));
