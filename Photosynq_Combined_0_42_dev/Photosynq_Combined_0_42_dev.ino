...
//  long* data_raw_average = (long*)malloc(4);
  unsigned short* data_raw_average = (unsigned short*)malloc(4);
...
//        data_raw_average = (long*)calloc(size_of_data_raw,sizeof(long));                   // get some memory space for data_raw_average, initialize all at zero.
        data_raw_average = (unsigned short*)calloc(size_of_data_raw,sizeof(unsigned short));                   // get some memory space for data_raw_average, initialize all at zero.
