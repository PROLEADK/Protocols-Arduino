...
void lighttests2() {
  ...
  while (choose!=999) {
   ...
   if (choose<30) {
      ...
      case 1710:
        for (x=0;x<5000;x++) {
          Serial1.println(analogRead(A10));
          delay(10);
        }
        break;
      ...
      case 1711:
        for (x=0;x<5000;x++) {
          Serial1.println(analogRead(A11));
          delay(10);
        }
        break;
      }
...
datasample = (int*)malloc(300*sizeof(int)); // create the array of proper size to save one value for all each ON/OFF cycle
...
//          calibrationsample();                                                                         // Run calibration
    ...
    for (i=0;i<p;i++) { // Print and save the results!
      Serial.print(datasample[i]);
      Serial.print(",");
      float datapoint = datasample[i];
      savecalibration(datapoint,i*10);
    }
  }
  Serial.print("\"end\":1");
  Serial.println("}");
