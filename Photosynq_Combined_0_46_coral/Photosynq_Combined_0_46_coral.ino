...
let's deal with the loss of cancel during the delay
 ...
 Most recent updates (46_coralspeq):
 - Updated with new hardware configuration as of 11/5/2015, eliminated the Serial3 port and switch pins 7 and 8 to use by coralspeq for clock and data.
