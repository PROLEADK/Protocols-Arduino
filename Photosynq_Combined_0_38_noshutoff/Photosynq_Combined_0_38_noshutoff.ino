...
*/
        ...
        print_get_userdef0(get_userdef0,get_userdef1,get_userdef2,get_userdef3,get_userdef4,get_userdef5,get_userdef6); // check to see if we need to print any of the user defined calibrations
...
void print_get_userdef0(int _0,int _1,int _2,int _3,int _4,int _5,int _6) {
    if (_0 == 1) {
      Serial.print("\"get_userdef0\":[");
      Serial.print(userdef0[0]);
      Serial.print(",");
