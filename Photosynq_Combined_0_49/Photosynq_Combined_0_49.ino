...
act_lights : [[3,4,5]]
act_intensities : [[254,450,900]]
meas_lights : [[2,3]]
meas_intensities[[500,100]]
detectors : [[34, 35]]
pulses : 
pulse_distance : 
pulse_size : 
...
Serial.println(_act1_light);
              ...
              case 3:
                dac1.analogWrite(0,meas_intensity);
              case 4:
                dac1.analogWrite(1,meas_intensity);
              case 5:
                dac1.analogWrite(2,meas_intensity);
              case 20:
                dac1.analogWrite(3,meas_intensity);
/*
              case 5:
                dac1.analogWrite(0,act_intensity); 
              case 6:
                dac1.analogWrite(0,act_intensity);   
              case 7:
                dac1.analogWrite(2,cal_intensity);        
              case 8:
                dac1.analogWrite(2,cal_intensity);        
              case 9:
                dac1.analogWrite(2,cal_intensity);        
...
*/
              ...
              switch (_act1_light) {                                                                    // now set the DAC intensity for the actinic lights (act1 - act4)
                case 3:
                  dac1.analogWrite(0,meas_intensity);
                case 4:
                  dac1.analogWrite(1,meas_intensity);
